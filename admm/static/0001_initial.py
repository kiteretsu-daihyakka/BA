# Generated by Django 2.2.3 on 2019-12-14 12:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressline1', models.TextField(blank=True, db_column='AddressLine1')),
        ...
        migrations.CreateModel(
            name='Advimgs',
            fields=[
                ('advertisement_advid', models.ForeignKey(db_column='Advertisement_AdvId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Advertisement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('orderdetail_orderid', models.ForeignKey(db_column='OrderDetail_OrderId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Order')),
        ...
        migrations.CreateModel(
            name='Docdetail',
            fields=[
                ('userdetail_userid', models.ForeignKey(db_column='UserDetail_UserId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Userdetail')),
                ('sellerdoclist_docid', models.IntegerField(db_column='SellerDocList_DocId')),
                ('docpath', models.TextField(db_column='DocPath')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('offerdetail_offerid', models.ForeignKey(db_column='OfferDetail_OfferId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Offerdetail')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Orderdetails',
            fields=[
                ('order_orderid', models.ForeignKey(db_column='Order_OrderId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Order')),
        ...
        migrations.CreateModel(
            name='PackageHasAdv',
            fields=[
                ('package_packageid', models.ForeignKey(db_column='Package_PackageId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admm.Package')),
                ('quantity', models.IntegerField(blank=True, db_column='Quantity', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('orderid', models.ForeignKey(db_column='OrderId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='ordIdForUpd', serialize=False, to='admm.Orderdetails')),
