...
#     advregno = models.CharField(db_column='AdvRegNo', unique=True, max_length=45, blank=True, null=True)  # Field name made lowercase.
...
#     area_areaid = models.ForeignKey('Area', models.DO_NOTHING, db_column='Area_AreaId', blank=True, null=True,name="id")  # Field name made lowercase.
...
#     defaultimgpath = models.ImageField(upload_to='media')  # Field name made lowercase.
...
#     imagepath = models.ImageField(upload_to='media')  # Field name made lowercase.
#
#     class Meta:
#         managed = False
#         db_table = 'advimgs'
...
#     branch_branchid = models.ForeignKey('Branch', models.DO_NOTHING, db_column='branch_BranchId', blank=True, null=True)  # Field name made lowercase.
...
#     secqueans = models.TextField(db_column='secQueAns')  # Field name made lowercase.
...
#     orderid = models.ForeignKey('Orderdetails', models.DO_NOTHING, db_column='OrderId', primary_key=True,related_name="ordid_cancellation")  # Field name made lowercase.
#     advid = models.ForeignKey('Orderdetails', models.DO_NOTHING, db_column='AdvId',related_name="advid_cancellation")  # Field name made lowercase.
...
#         managed = False
#         db_table = 'cartdetail'
#         unique_together = (('advertisement_advid', 'auth_user'),)
#
#
...
#     auth_user = models.ForeignKey(AuthUser, models.DO_NOTHING, primary_key=True)
...
#     category_categoryid = models.ForeignKey(Category, models.DO_NOTHING, db_column='Category_CategoryId')  # Field name made lowercase.
#
#     class Meta:
#         managed = False
...
#     orderid = models.ForeignKey(Orderdetails, models.DO_NOTHING, db_column='OrderId', primary_key=True,related_name="ordid_updation")  # Field name made lowercase.
#     advid = models.ForeignKey(Orderdetails, models.DO_NOTHING, db_column='AdvId',related_name="advid_updation")  # Field name made lowercase.
